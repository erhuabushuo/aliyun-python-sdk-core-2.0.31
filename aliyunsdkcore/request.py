...
from .httplib import protocol_type as PT
from .httplib import method_type as MT
from .httplib import format_type as FT
...
class RpcRequest(AcsRequest):
	...
	"""
	def __init__(self, product, version, action_name, format=None, protocol=None):
		AcsRequest.__init__(self, product, version, action_name, format, protocol, MT.GET)
...
class RoaRequest(AcsRequest):
	...
	"""
	def __init__(self, product, version, action_name, method=None, headers=None, uri_pattern=None, path_params=None, protocol=None):
		"""
		...
		:return:
		"""
		AcsRequest.__init__(self, product, version, action_name, FT.RAW, protocol, method)
...
class OssRequest(AcsRequest):
	...
	def __init__(self, product, version, action_name, bucket=None, method=None,
		...
		:return:
		"""
		AcsRequest.__init__(self, product, version, action_name, FT.XML, protocol, method)
